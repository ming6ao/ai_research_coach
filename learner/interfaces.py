...
if TYPE_CHECKING:
    ...
    from learner.states import Learner, LearnerKnowledgeState
    from learner.misconception import LearnerMisconception, MisconceptionEvidenceLink
...
class MisconceptionRepository(Protocol):
    ...
    Evidence links are stored as a JSON list on the misconception's metadata
    (the dedicated join table was dropped in the merge).
    """
